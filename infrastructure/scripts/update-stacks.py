...
for region in regions:
    ...
    try:
        ...
        cfn.update_stack(args.stack_name, template_body=template_body, template_url=template_url, parameters=tuple(parameters.items()), notification_arns=notification_arns,
